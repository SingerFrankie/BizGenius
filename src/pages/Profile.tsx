  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
        ...
        <p className="text-gray-600 mt-4 leading-relaxed">{formData.bio}</p>
      </div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              {isEditing && (
                <div className="flex space-x-2">
                  <button
                    onClick={handleSave}
                    className="px-3 py-1 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors flex items-center space-x-1"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-sm font-medium text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 transition-colors flex items-center space-x-1"
                  >
                    <X className="h-4 w-4" />
                    <span>Cancel</span>
                  </button>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900">{progress.coursesCompleted}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900">{progress.businessPlansCreated}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900">{progress.learningStreak} days</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900">{progress.achievements.length}</span>
              </div>
            </div>
          </div>
